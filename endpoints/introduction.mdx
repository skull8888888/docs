...
Endpoints live inside projects and are uniquely identified and accessible by their name.
Check [OpenAPI specification](/api-reference/endpoint/endpoint_run) on how to call endpoint.
...
Read detailed instructions on how to call endpoint in [OpenAPI specification](/api-reference/endpoint/endpoint_run).
...
The environment variables from [env variables](/pipeline/env-variables) page won't be applied, since they are only stored in your browser.
