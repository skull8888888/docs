...
You can think of map node as a for-loop which will iterate over all of the inputs. The only difference is that all inputs will be processed in parallel and, hence, all subpipelines will be run in parallel.
