...
We are currently adding support for converting other provider's tool calling format to OpenAI format, please contact us
...
def my_tool(arg1: string, arg2: string) -> NodeInput {
    return f'{arg1}{arg2}'
}
