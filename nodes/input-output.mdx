...
For example, `StringList` input node produces a `String` output and can be connected only to input handles expecting `String` value, e.g. Semantic Search's `query` handle.
