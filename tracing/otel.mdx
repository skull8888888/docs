...
| events [2] | Events associated with the span | | | |
...
[1] 13th digin in hex UUID depends on UUID version, so technically converting [OTel/WC3's](https://www.w3.org/TR/trace-context/#trace-id) 16-byte and, especially, 8-byte IDs
