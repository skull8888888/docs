...
Laminar Python is available on [PyPI](https://pypi.org/project/lmnr). You can install it using pip.
...
`Laminar.initialize()` will enable OpenLLMetry's automatic tracing of LLM calls, vector DBs calls, and more.
...
Laminar JavaScript is available on [npm](https://www.npmjs.com/package/@lmnr-ai/lmnr). You can install it using npm.
...
Read on to the [Next section](/tracing/otel) to learn more about the OpenTelemetry objects and attributes that Laminar uses.