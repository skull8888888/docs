...
Our backend is Opentelemetry-compatible destination and serves ingestion through gRPC.
Majority of the Opentelemetry-compatible instrumentations for LLM and VectorDB libraries are provided by [OpenLLMetry](https://github.com/traceloop/openllmetry).
