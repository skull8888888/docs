...
you can do simple initialization, however, you will need to import and initialize Laminar **before importing LLM client libraries**.
...
However, we do not recommend this approach for production as it may lead to unexpected behavior in the future.
