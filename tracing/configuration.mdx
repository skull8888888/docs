...
<Warning> If you are using Next.js, you may need to manually pass all libraries which you want Laminar to auto-instrument. Check [next section](#instrument-specific-modules-only)  </Warning>
