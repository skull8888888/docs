...
These Terms of Service, published by Laminar AI (the "**Supplier**") govern the use of and access to our Services by you (the "**Customer**") and together with the Order Form shall hereafter be referred to as the "**Agreement**". Each of the Customer and the Supplier shall be a "**Party**" and together the "**Parties**".
