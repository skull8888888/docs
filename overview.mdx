...
Perform advanced hybrid search on datasets to augment your prompts with the most semantically relevant.

Learn more about [Data labeling](/datasets/label-spans) and [Datasets](/datasets/introduction).

### Evaluations

In addition to semantic events, Laminar allows you to run evaluations offline and analyze their
