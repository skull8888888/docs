...
### Observability
With Laminar, you can instrument your entire LLM application and track full execution trace. Adding instrumentation is as simple as adding a python decorator to your function. Get started with [instrumentation](/documentation/tracing/introduction).
...
Learn more about prompt chains in [prompt chains](/documentation/pipeline/introduction).
