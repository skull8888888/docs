...
It is fully compatible with OpenTelemetry through the means of [OpenLLMetry](https://github.com/traceloop/openllmetry).
...
You can build and host chains of prompts and LLMs and then call them as ifthey were single function.
