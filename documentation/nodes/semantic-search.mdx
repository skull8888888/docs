...
Datasources of semantic search nodes are simply datasets. You can go to "datasets" page, create a dataset, add datapoints, index them, and then use it here [(Read more)](/documentation/datasets/introduction#indexing).
