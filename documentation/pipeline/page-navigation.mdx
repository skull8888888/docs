...
- "Deploy" button to [deploy to an endpoint](/documentation/pipeline/run-save-deploy#deploying-a-pipeline-version).
...
The bottom drawer shows the execution outputs. This includes the outputs of this run and the history of runs of this version. The latter is a minimised version of the [logs page](/documentation/logs/introduction).
