...
**Commit** – an immutable saved snapshot of a pipeline, similar to a git commit. Commit versions can be deployed to [endpoints](/documentation/endpoints/introduction)
