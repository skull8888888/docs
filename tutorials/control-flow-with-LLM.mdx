...
Check our [Function node](/documentation/nodes/function-call) and try to add it into the flow. You can write a code which further searches the web, when the LLM decides it needs to search the web.
