...
description: Build LLM pipeline on Laminar and deploy it as a Laminar endpoint
---

This tutorial will teach you how to build LLM pipeline on Laminar, then expose it as an API,
