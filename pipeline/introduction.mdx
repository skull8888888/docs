...
1. and now Laminar will redirect your calls to this new pipeline target version.

You don't have to go through another deployment of your entire codebase for each small change.
...
Then go to the newly created commit and click "Set as Target".
