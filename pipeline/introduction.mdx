...
First, create a pipeline, by clicking "New pipeline" button in the pipelines page. Give it a custom name. You will be redirected to the page of the newly created pipeline. Your pipeline will have initially have two nodes. One for input and one for output
