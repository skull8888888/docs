...
- If your pipeline requires environment variables, set then in [env variables](/pipeline/env-variables) page.
...
1. If your endpoint has checks of type "Evaluation", then make sure all required [env variables](/pipeline/env-variables) are set.
