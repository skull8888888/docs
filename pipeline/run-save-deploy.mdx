...
Once you are happy with your pipeline and ready to use it in external applications, be it testing or production, you can deploy your pipeline version to an endpoint. This will create a new commit and link an endpoint to it.
