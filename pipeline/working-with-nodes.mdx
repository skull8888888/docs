...
In addition, whenever you drag and drop a new input node, an input field will appear in the sidebar on the left. You must fill this field in in order to run the pipeline.
