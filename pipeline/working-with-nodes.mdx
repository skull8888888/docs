...
For relevant nodes, e.g. [Chat](/nodes/chat-instruct-llm-nodes#chat-node) and [Instruct](/nodes/chat-instruct-llm-nodes#instruct-node),
...
To start, simply enclose a word in your node's instruction/system message field. After that, a new input handle of type `String`, named with that enclosed word,
